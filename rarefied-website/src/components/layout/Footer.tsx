...
import { SITE_CONFIG, PLATFORM_LINKS, NAV_LINKS } from "@/lib/constants";
      ...
      <div className="container-wide py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-lg font-semibold mb-3">Rarefied</h3>
        ...
        <div className="mt-12 pt-6 border-t border-white/20 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-white/60 text-sm">
            &copy; {new Date().getFullYear()} Rarefied Podcast. All rights reserved.
          </p>
